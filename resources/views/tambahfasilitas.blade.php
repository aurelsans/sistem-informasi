    ...
    <section class="bg-white dark:bg-gray-900 ">
        <div class="mx-auto max-w-screen-xl lg:py-8">
            <div
                ...
                <form action="/simpanfasilitas" method="post">
                    ...
                    <select id="lab_id" name="lab_id"
                        ...
                        <option>Select One</option>
                            <option value="{{ $f->id }}">{{ $f->ruangan }}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="nama_fasil" name="nama_fasil"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="detail_fasil" name="detail_fasil"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 
                            focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                            dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
