...
<body class="font-sans">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <h2 class="text-2xl font-bold tracking-tight dark:text-white">Fasilitas Laboratorium</h2>
            <a href="tambahfasilitas"><button
                        ...
                        <table class="rounded-t-lg table-auto text-sm text-left rtl:text-right ">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-2">Nama Fasilitas</th>
                                    <th scope="col" class="px-4 py-2">Detail Fasilitas</th>
                            ...
                            @foreach($fasilitas as $f)
                                <tr>
                                        ...
                                        <td scope="col" class="border px-4 py-3">{{ $f->ruangan }}</td>
                                        <td scope="col" class="border px-4 py-3">{{ $f->nama_fasil }}</td>
                                        <td scope="col" class="border px-4 py-3">{{ $f->detail_fasil }}</td>
                                        <td scope="col" class="border px-4 py-3">
                                            <a href="/editfasilitas/{{ $f->fasilitas_id }}">
                                                <button
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 flex items-center text-red-500 mx-auto"
                        ...
                        <h2 class="text-xl font-bold py-4 ">Are you sure?</h3>
                            ...
                            <a href="/hapusfasilitas/{{ $f->fasilitas_id }}">
