...
<body class="font-sans">
               ...
               <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
                  ...
                  <li class="me-2" role="presentation">
                     <button class="inline-block p-4 border-b-2 rounded-t-lg" id="profile-tab"
                        ...
                        aria-selected="false">Beranda</button>
                  </li>
                  <!-- End Beranda -->

                  <!--Penelitian-->
                  <li class="me-2" role="presentation">
                     <button id="penelitian-tab" data-dropdown-toggle="dropdownNavbarPen" data-dropdown-trigger="hover"
                        class="inline-block p-4 border-b-2 rounded-t-lg hover:text-blue-600 hover:border-blue-600 dark:hover:text-gray-300
                     ...
                     <div id="dropdownNavbarPen"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="penelitian-tab">
                           <li>
                              <a href="/laboratorium"
                  ...
                  <li class="me-2" role="presentation">
                     ...
                     <div id="dropdownNavbarMhs"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="kemahasiswaan-tab">
                           <li>
                              <a href="/layanan"
                  ...
                  <li role="presentation">
                     ...
                     <div id="dropdownNavbarKurikulum"
                        class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="kurikulum-tab">
                           <li>
                              <a href="/cpl"
                                 class="block px-4 py-2 text-left dark:hover:bg-gray-600 dark:hover:text-white">
                                 CPL</a>
                  ...
                  <!-- Tentang -->
                  <li role="presentation">
                     <button id="tentang-tab" data-dropdown-toggle="dropdownNavbarTentang" data-dropdown-trigger="hover"
                        class="inline-block p-4 border-b-2 rounded-t-lg hover:text-blue-600 hover:border-blue-600 dark:hover:text-gray-300
                     ...
                     <div id="dropdownNavbarTentang"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="tentang-tab">
                           ...
                           <li>
                              <a href="/kontak"
                                 class="block px-4 py-2 text-left dark:hover:bg-gray-600 dark:hover:text-whitee">Kontak</a>
                           </li>
                  </li>
               </ul>
            </div>
   ...
   <div id="default-tab-content">
      ...
      <!-- ################# START BERANDA ################# ----------------------------------------------------------------------------------- -->
      <div class="hidden p-4 rounded-lg lg:bg-gray-50 lg:dark:bg-gray-800" id="profile" role="tabpanel"
         aria-labelledby="profile-tab">

         <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-15"></div>
         </section>

         <section
            class="bg-fixed bg-center bg-no-repeat bg-[url('https://upload.wikimedia.org/wikipedia/commons/b/b3/Drone_Unmuh_Jember.jpg')] bg-gray-500 bg-blend-multiply">
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
               <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
                  Program Studi Sistem Informasi</h1>
               <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Universitas Muhammadiyah
                  Jember.</p>
               <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                  <a href="https://pmbonline.unmuhjember.ac.id/"
                     class="transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                  ...
                  <a href="https://unmuhjember.ac.id/id/"
         ...
         <section class="py-10 lg:bg-white dark:bg-gray-900">
            <!-- profile ----------------------------------------------------------------------------------- -->
            <div class="mx-auto max-w-screen-xl">
               <div
                  class="bg-brand-blue dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
                  <h1 class="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">Profile</h1>
                  <p class="text-lg font-normal text-white dark:text-gray-400 mb-6">Program Studi Sistem Informasi
                  </p>
               </div>
            </div>
            <!-- END profile ----------------------------------------------------------------------------------- -->

            <div class="py-0 mx-auto max-w-screen-xl ">
               <div class="grid lg:grid-cols-2 gap-12">
                  ...
                  <div id="accordion-color" data-accordion="collapse"
                     ...
                     <div id="accordion-color-body-1" class="hidden" aria-labelledby="accordion-color-heading-1">
                        <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                           <p class="mb-2 text-gray-500 dark:text-gray-400">Desc visi 1</p>
                           <p class="text-gray-500 dark:text-gray-400">Desc visi 2</p>
                        </div>
                     </div>
                     ...
                     <div id="accordion-color-body-2" class="hidden" aria-labelledby="accordion-color-heading-2">
                        <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                           <p class="mb-2 text-gray-500 dark:text-gray-400">Desc Misi</p>
                           <p class="mb-2 text-gray-500 dark:text-gray-400">Desc Misi 2</p>
                           <p class="mb-2 text-gray-500 dark:text-gray-400">etc:</p>
                  ...
                  <div class="grid lg:grid-cols-2 gap-4">
                     <a href="/cpl" type="button"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-10 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Capaian
                        Pembelajaran Lulusan (CPL)</a>
                     <a href="/kurikulum" type="button"
                        class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-10 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Kurikulum</a>
                     <a href="/profesi" type="button"
                        class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-10 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Profesi</a>
                     <a href="/profil" type="button"
                        class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-10 me-2 mb-2 dark:focus:ring-yellow-900">Profil
                        Lulusan</a>
                  </div>
                  <!-- END kurikulum ----------------------------------------------------------------------------------- -->
               </div>
