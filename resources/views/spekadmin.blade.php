...
<body class="font-sans">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <h2 class="text-2xl font-bold tracking-tight dark:text-white">Spesifikasi Laboratorium</h2>
            <a href="/tambahlaboratorium"><button
                    ...
                    Laboratorium</button></a>
            
            <a href="/tambahspesifikasi"><button
                    class="mt-4 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Tambah
                    Spesifikasi</button></a>
                    ...
                    <div class="mt-4 mb-4 relative shadow-md sm:rounded-lg">
                        ...
                        <table class="rounded-t-lg table-auto text-sm text-left rtl:text-right ">
                            ...
                            <thead
                                ...
                                <tr>
                                    <th scope="col" class="px-4 py-2">Laboratorium</th>
                                    <th scope="col" class="px-4 py-2">Nama Spesifikasi</th>
                                    <th scope="col" class="px-4 py-2">Detail Spesifikasi</th>
                            ...
                            <tbody>
                                @foreach($spesifikasi as $s)
                                        <tr>
                                            ...
                                            <td scope="col" class="border px-4 py-3">{{ $s->ruangan }}</td>
                                            <td scope="col" class="border px-4 py-3">{{ $s->nama_spek }}</td>
                                            <td scope="col" class="border px-4 py-3">{{ $s->detail_spek }}</td>
                                            <td scope="col" class="border px-4 py-3">
                                                <a href="/editspesifikasi/{{ $s->spesifikasi_id }}">
                                                    <button
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <a href="/hapusspesifikasi/{{ $s->spesifikasi_id }}">
