...
<body class="font-sans">
    ...
    <!-- end drawer-->
      ...
      <!-- !!!!!!!!!!!!!!!!!!!!!! START PROFESI !!!!!!!!!!!!!!!!!!!!!!!!! --------------------------------------------------------- -->
         <div class="bg-white dark:bg-gray-900 py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-20"></div>
         ...
         <section class="dark:bg-dark bg-white py-[70px]">
            <div class="mx-auto px-4 sm:container">
               <div class="border-primary border-l-[5px] pl-5">
                  ...
                  <p class="text-body-color dark:text-dark-6 text-sm font-medium">
                     Lulusan dari Program Studi Sistem Informasi memiliki pengetahuan dan keterampilan yang luas dalam
            ...
            <div class="py-0 px-16 mx-auto max-w-screen-xl py-8">
