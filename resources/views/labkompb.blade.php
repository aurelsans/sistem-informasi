...
<body class="font-sans">
   ...
   <section class="bg-white dark:bg-gray-900">
      <div class="py-12 mx-auto max-w-screen-xl text-center lg:py-8"></div>
   </section>
   <section class="h-96 py-32 relative" id="home">
        <div class="overflow-hidden">
            <img class="absolute inset-0 h-full w-full object-cover"
                src="/gambar/kompbicon.jpg"
                alt="build your website">
            <div class="absolute inset-0 bg-gradient-to-r from-[#1e2026] to-[#000000] opacity-50"></div>
        </div>
                ...
                <div class="lg:w-2/3 text-center relative">
                    <div class="space-y-6 mb-10">
                        ...
                        <h2 class="text-white text-4xl md:text-5xl lg:text-6xl leading-tight capitalize font-bold">
                           Laboratorium Komputer 4.1B
                        </h2>
                        <p class="text-gray-300 text-base md:text-lg">
                           Fasilitas Laboratorium Prodi Sistem Informasi.
                        </p>
                    </div>
                </div>
            </div>
  ...
  <ol class="mt-12 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
    <li
      class="flex items-center font-sans text-sm antialiased font-normal leading-normal transition-colors">
      <a href="/indexsi" class="text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white opacity-80">
    ...
    <li
      class="flex items-center font-sans text-sm antialiased font-normal leading-normal transition-colors">
      <a href="/laboratorium" class="ext-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white opacity-80">
        Laboratorium
      </a>
      <span
        class="mx-2 font-sans text-sm antialiased font-normal leading-normal pointer-events-none select-none text-blue-gray-500">
    ...
    <li
      class="flex items-center font-sans text-sm antialiased font-normal leading-normal transition-colors">
      <a href="/labkomp" class="ext-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white opacity-80">
    ...
    <li
      ...
      <span>Laboratorium Komputer 4.1B</span>
    </li>
  </ol>
</nav>
   ...
   <div class="py-8 mx-auto max-w-screen-xl lg:py-8">
               <div class="px-4 mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                     <h2 class="md:p-4 ml-0 text-cyan-800 mb-2 text-lg sm:text-3xl md:text-4xl font-bold dark:text-white mx-4">Laboratorium Komputer 4.1B</h2>
                  ...
                  <ul class="ps-5 text-black-500 list-disc dark:text-gray-400">


                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        <div>
                        <div class="gdlr-core-text-box-item-content"
                        style="font-size: 16px text-slate-600">
                        <p>Laboratorium komputer di gedung CC, lantai 4, ruangan 4.1B, 
                            menawarkan fasilitas lengkap untuk mendukung kegiatan belajar dan riset. 
                            Berikut adalah daftar fasilitas dan spesifikasi perangkat keras yang tersedia 
        ...
        <!-------------------------------- Akhir Pemanggilan Data ---------------------------------->
                     ...
                     <li class="text-body-color mt-3 dark:text-dark-6 flex text-base">
                        ...
                        <div class="gdlr-core-text-box-item-content"
                        style="font-size: 16px text-slate-600">
                        <p>Dengan fasilitas yang lengkap dan perangkat keras yang baik, laboratorium komputer ini memberikan 
                            lingkungan yang kondusif bagi pengguna untuk melakukan berbagai jenis tugas komputasi, penelitian, 
                            atau pembelajaran dengan efisien dan efektif. Semua spesifikasi perangkat keras yang disebutkan 
                            berjumlah 24 dan dalam kondisi baik.
                        </p>
                     </div>
                     </li>
                  </ul>
                  ...
                  <div class="px-4 mt-2 mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                     <h2 class="md:p-4 ml-0 text-cyan-800 mb-2 text-lg sm:text-3xl md:text-4xl font-bold dark:text-white mx-4">Detail Laboratorium</h2>
                        <div class="flex-grow border-t-4 border-blue-100 dark:border-gray-700"></div>
                  </div>
          <!-- Articles-->
          <div
            class=" grid  gap-6 px-8 mt-4  md:grid-cols-2 lg:grid-cols-3 pb-12"
          >
            ...
            >
              ...
              >
                  <img
                    class="object-cover w-full h-full transition duration-300 ease-in-out rounded-t-2xl group-hover:scale-110 lazy"
                    src="gambar/labkompb1.jpg"
                  />
              </div>
            </article>
          ...
          <div class="px-4 mt-2 mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                     <h2 class="md:p-4 ml-0 text-cyan-800 mb-2 text-lg sm:text-3xl md:text-4xl font-bold dark:text-white mx-4">Laboratorium Komputer 4.1A</h2>
                        <div class="flex-grow border-t-4 border-blue-100 dark:border-gray-700"></div>
                  </div>
          <article
              class="px-8 relative mt-2 flex flex-col flex-wrap transition duration-300 ease-in-out group"
            >
              <!-- Image -->
              <div
                class="relative z-10 w-full overflow-hidden aspect-w-2 aspect-h-1 bg-gray-50"
              >
              <a href="/labkompa">
                  <img
                    class="object-cover w-full h-64 transition duration-300 ease-in-out group-hover:scale-110 lazy"
                    src="gambar/kompaicon.png"
                  />
                  </a>
              </div>
            </article>
