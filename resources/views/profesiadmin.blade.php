...
<body class="font-sans">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <h2 class="text-2xl font-bold tracking-tight dark:text-white">Profesi Lulusan</h2>
            <a href="/tambahprofesi"><button
                    ...
                    <div class="mt-4 mb-4 relative shadow-md sm:rounded-lg">
                        <table class="rounded-t-lg table-auto text-sm text-left rtl:text-right ">
                            <thead
                                ...
                                <tr>
                                    <th scope="col" class="px-4 py-2">Profesi</th>
                                    <th scope="col" class="px-4 py-2">Deskripsi Profesi</th>
                            ...
                            @foreach($profesi as $pro)
                                <tr>
                                        ...
                                        <td scope="col" class="border px-4 py-3">{{$pro->nama_profesi}}</td>
                                        <td scope="col" class="border px-4 py-3">{{$pro->deskripsi_profesi}}</td>
                                        <td scope="col" class="border px-4 py-3">
                                            <a href="/editprofesi/{{ $pro->id }}">
                                                <button
