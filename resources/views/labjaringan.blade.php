...
<body class="font-sans">
  ...
  <ol class="mt-12 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
    ...
    <li
      ...
      <span>Laboratorium Jaringan</span>
    </li>
  </ol>
</nav>
   ...
   <div class="py-8 mx-auto max-w-screen-xl lg:py-8">
               <div class="px-4 mx-auto max-w-screen-xl mx-auto sm:container flex items-center">
                     <h2 class="md:p-4 ml-0 text-cyan-800 mb-2 text-lg sm:text-3xl md:text-4xl font-bold dark:text-white mx-4">Laboratorium Jaringan</h2>
                  ...
                  <ul class="ps-5 text-black-500 list-disc dark:text-gray-400">
                    ...
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        ...
                        <p>Laboratorium jaringan yang terletak di gedung CC, lantai 3, ruangan 3.1, 
                            Laboratorium ini dilengkapi dengan fasilitas lengkap yang mendukung berbagai kegiatan pengembangan, pengujian, dan pemelajaran terkait jaringan komputer. 
    ...
    <!-------------------------------- Pemanggilan Data ---------------------------------->
     ...
     <li class="text-body-color dark:text-dark-6 flex text-base">
                    ...
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                     ...
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                    <div>
                        <div class="mt-4 mb-2 font-bold text-3xl text-slate-700">Spesifikasi Router</div>
                    </div>
                </li>
                @foreach ($data2['router'] as $router)
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        <p class="text-lg mr-2.5 mt-1 text-md text-slate-600"><b>{{ $router->merek }}</b></p>
                    </li>
                    @foreach ($data2['detail_router'] as $detail_router)
                        @if($detail_router->router_id == $router->id)
                            <li class="text-body-color dark:text-dark-6 flex text-base ml-5">
                                <span class="bg-cyan-400 mr-2 mt-2.5 flex h-2 w-full max-w-[8px] items-center justify-center rounded-full text-base"></span>
                                <p><b>{{ $detail_router->router_spek }}:</b> {{ $detail_router->router_detail }}</p>
                            </li>
                        @endif
                    @endforeach
                @endforeach
        ...
        <!-------------------------------- Akhir Pemanggilan Data ---------------------------------->
                     ...
                     <li class="text-body-color mt-3 dark:text-dark-6 flex text-base">
                        ...
                        <div class="gdlr-core-text-box-item-content"
                        style="font-size: 16px text-slate-600">
                        <p>Dengan fasilitas lengkap dan perangkat keras yang memadai, laboratorium jaringan ini 
                            menyediakan lingkungan yang kondusif bagi para pengguna untuk melakukan berbagai jenis 
                            tugas komputasi, penelitian, atau pembelajaran dengan efisien dan efektif.
                        </p>
                     </div>
                     </li>
                  </ul>
