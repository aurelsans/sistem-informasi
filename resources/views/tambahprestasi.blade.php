    ...
    <section class="bg-gray-50 dark:bg-gray-900 ">
        <div class="mx-auto max-w-screen-xl lg:py-8">
            <div
                ...
                <h1 class="text-2xl mb-4 font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                    Tambah Prestasi
                </h1>

                <form class="w-full" action="/simpanprestasi" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-1 mb-2 text-sm text-gray-500 dark:text-gray-300">
                        Tambahkan foto prestasi yang ingin dimasukkan.
                    </div>
                    ...
                    <textarea id="detail_prestasi" name="detail_prestasi" rows="4"
                        ...
                        placeholder="Tulis detail prestasi..."></textarea>
