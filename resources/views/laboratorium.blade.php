  ...
  <ol class="mt-12 flex flex-wrap items-center w-full px-12 rounded-md bg-blue-gray-50 bg-opacity-60">
    ...
    <li
      ...
      <span>Laboratorium</span>
         ...
         <section class="lg:bg-white dark:bg-gray-900">
            ...
            <div class="mx-auto max-w-screen-xl lg:py-8">
               <div
                  ...
                  <ul class="lg:ps-5 text-black-500 list-disc dark:text-gray-400">
                    ...
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        ...
                        <div>
                            <div class="font-bold text-xl text-slate-700">Laboratorium Komputer</div>
                                <p class="text-sm mb-2 text-slate-600">
                                    Dua laboratorium komputer yang terletak di gedung CC lantai 4, yaitu 
                                    ruangan 4.1A dan 4.1B, menyediakan fasilitas lengkap bagi penggunanya. 
                                    Di kedua ruangan tersebut, tersedia AC untuk menjaga suhu yang nyaman, 
                                    sambungan WiFi yang stabil, dan fasilitas lainnya. Terdapat 
                                    total 48 komputer dalam kondisi baik siap digunakan.</p>
                            </div>
                     </li>
                    ...
                    <li class="text-body-color dark:text-dark-6 flex text-base">
                        ...
                        <div>
                            <div class="font-bold text-xl text-slate-700">Laboratorium Jaringan</div>
                                <p class="text-sm mb-2 text-slate-600">
                                    Laboratorium jaringan yang terletak digedung CC lantai 3 ruangan 3.1</p>
                            </div>
                     </li>
                     ...
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        ...
                        <div>
                            <div class="font-bold text-xl text-slate-700">Laboratorium IOT</div>
                                <p class="text-sm mb-2 text-slate-600">Laboratorium IOT yang terletak digedung CC lantai 3 ruangan 3.6</p>
                            </div>
                     </li>
                     ...
                     <li class="text-body-color dark:text-dark-6 flex text-base">
                        ...
                        <div>
                            <div class="font-bold text-xl text-slate-700">Laboratorium Enterprise</div>
                                <p class="text-sm mb-2 text-slate-600">Laboratorium enterprise yang terletak digedung CC lantai 3 ruangan 3.7</p>
                            </div>
                     </li>
                  </ul>
                  </p>
         ...
         <div class="py-4 lg:py-0 px-4 mx-auto max-w-screen-xl mb-8">
         <div class="mx-auto max-w-screen-xl">
            ...
            <div class="grid px-6 lg:grid-cols-4 gap-4 place-items-center">
               <div
                  class="max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="/labkomp">
                     <img class="rounded-lg" src="gambar/laboratoriumkomp.jpg" alt="" />
                  </a>
               </div>
               <div
                  class="max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="/labjaringan">
                     <img class="rounded-lg" src="gambar/labjar.png" alt="" />
                  </a>
               </div>
               <div
                  class="max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="labenter">
                     <img class="rounded-lg" src="gambar/labenterprise.jpg" alt="" />
                  </a>
               </div>
               <div
                  class="max-w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                  <a href="labiot">
                     <img class="rounded-lg" src="gambar/labiot.jpg" alt="" />
                  </a>
               </div>
            </div>
         </div>
